  ...
  return (
    <div className="space-y-12">
      <div>
        ...
        <p className="text-zinc-400 font-black text-[10px] uppercase tracking-widest">Acesse ferramentas exclusivas para potencializar seus resultados.</p>
      </div>
      ...
      <div className="p-8 bg-zinc-900/50 border border-zinc-800 border-dashed rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <button className="px-6 py-3 bg-indigo-600 text-white rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all active:scale-95 shadow-lg shadow-indigo-600/10">
          Ver Documentação
        </button>
      </div>
    </div>

    ...
    <div className="flex flex-col space-y-6 w-full max-w-[1200px] mx-auto py-4">
      ...
      <div className="flex justify-center pb-12">
        <button 
          ...
          className="px-12 py-5 bg-indigo-600 border border-indigo-500 hover:bg-indigo-700 text-white rounded-2xl transition-all group flex items-center gap-5 shadow-[0_20px_40px_-10px_rgba(59,130,246,0.3)] active:scale-95"
        >

...
import { Globe, Wand2, Target, Briefcase, Users, MessageSquare, MessageCircle, ArrowRight, ArrowLeft, Loader2, Database, Copy, Check, Eye, ChevronDown, ChevronUp, ChevronRight, Layout, PanelLeftClose, PanelLeftOpen, Star, Zap, ExternalLink, Terminal, DollarSign, Layers, Search } from 'lucide-react';
...
const SiteCreator: React.FC<Props> = ({ setView }) => {
  ...
  const approaches = [
    {
      ...
      continuationSteps: [
        ...
        { label: "Diferencial", msg: "O orçamento é *100% gratuito*, sem qualquer obrigação de fechar. E caso decida seguir, o site é entregue com *pagamento único*, sem mensalidades ou assinaturas, sendo sua de forma vitalícia." },
    ...
    },
    {
      ...
      continuationSteps: [
        { label: "Confirmação", msg: "Perfeito! 😄" },
        { label: "Portfólio", msg: "Separei alguns modelos que desenvolvi:\n\n📌 [LINK 1]\n📌 [LINK 2]\n📌 [LINK 3]" },
        { label: "Diferenciais", msg: "Todos foram criados pensando em atrair mais clientes pelo Google, transmitir mais confiança e facilitar o contato pelo WhatsApp." },
        { label: "Exclusividade", msg: "Se você gostar desse estilo, consigo criar um modelo exclusivo para a sua empresa." },
        { label: "Condições", msg: "Também funciona com *pagamento único*, sem mensalidades ou assinaturas. Depois de pronto, a página é sua." },
        { label: "Fechamento", msg: "Qual desses modelos você mais gostou?" }
      ]
    }
  ];
  ...
  const steps = [
    { id: 1, name: 'Nicho', icon: Target },
    { id: 2, name: 'Empresa', icon: Users },
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        <div>
          ...
          <p className="text-zinc-400 font-black text-[10px] uppercase tracking-widest">Siga os passos para construir sua máquina de vendas.</p>
        </div>
      </div>
          ...
          {step === 2 && (
            ...
            >
              <div className="bg-zinc-900 p-8 rounded-3xl border border-zinc-800 shadow-xl space-y-6">
                <div className="flex items-center space-x-3 text-indigo-400">
                  <Users size={24} />
                  <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Localização da Empresa</h3>
                </div>
            ...
            >
              <div className="bg-zinc-900 p-6 sm:p-8 rounded-3xl border border-zinc-800 shadow-xl space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest px-1">Nome da Empresa</label>
                    <input
                      type="text"
                      value={projectName}
...
O site deve ser moderno, totalmente responsivo para celular e desktop, e focado em conversão.`;
                    ...
                    <div className="w-full bg-zinc-950 border border-zinc-800 rounded-3xl p-8 font-mono text-[10px] text-zinc-400 leading-relaxed uppercase whitespace-pre-wrap shadow-inner">
                      ...
                      {`".\n\n`}
                      <span className="text-zinc-600">-- Parâmetros da Empresa --</span>
                  ...
                  <div className="bg-zinc-950 border border-zinc-800 rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center gap-8 group hover:border-indigo-500/30 transition-all">
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="w-full md:w-auto flex items-center justify-center space-x-4 bg-indigo-600 text-white px-10 py-5 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:bg-indigo-700 transition-all shadow-2xl active:scale-95 shrink-0"
                    >
                ...
                >
                  <div className="p-6 sm:p-8 space-y-8">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-3xl font-black text-white uppercase tracking-tighter">{approaches[activeApproach].title}</h3>
                        <p className="text-zinc-500 font-black text-[10px] uppercase tracking-widest mt-2">
                              ...
                              <div key={sIndex} className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5 relative group hover:border-emerald-500/30 transition-colors">
                                <div className="flex items-center justify-between mb-2">
                                  ...
                                  <button 
                                    onClick={() => {
                                      navigator.clipboard.writeText(step.msg);
                                      setCopiedId(`${activeApproach}-cont-${sIndex}`);
                                      setTimeout(() => setCopiedId(null), 2000);
                                    }}
      ...
      <div className="flex items-center justify-between pt-6 border-t border-zinc-800">
        ...
        <button
          ...
          className="flex items-center space-x-3 bg-indigo-600 text-white px-8 py-3.5 rounded-xl font-black uppercase tracking-widest text-[10px] hover:bg-indigo-700 transition-all shadow-xl active:scale-95 disabled:opacity-40"
        >
          <span>

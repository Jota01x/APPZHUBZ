                  ...
                  <div className="relative flex items-center justify-between px-8 py-5">
                    <div className="flex items-center space-x-5">
                      <div className="relative">
                        ...
                        <div className="relative bg-white/10 p-3 rounded-2xl backdrop-blur-sm">
                          <MessageCircle size={24} className="text-white" />
                        </div>
                      </div>
                      <div className="text-left">
                        <p className="text-[10px] font-black text-white/60 uppercase tracking-[0.2em] mb-0.5">Disponível Agora</p>
                        <p className="text-sm font-black text-white uppercase tracking-wider">Iniciar Prospecção Direta</p>
                      </div>
                    </div>
                    
                    <div className="flex items-center space-x-3 bg-black/20 px-4 py-2 rounded-xl backdrop-blur-md">
                      <span className="w-1.5 h-1.5 bg-emerald-400 rounded-full animate-pulse" />
                      <span className="text-[9px] font-black text-white uppercase tracking-widest">WhatsApp Business</span>
                    </div>
                  </div>
                </button>
              </div>
